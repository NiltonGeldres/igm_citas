...
// src/components/AtencionMedica/AntecedentesPanel.js
...
/**
 * Componente específico para el Panel de Antecedentes con dictado por voz.
...
const AtencionMedicaAntecedentePanel = ({ content, onContentChange, onModalMessage }) => {
  const title = "Panel Antecedentes"; // Título hardcodeado para este componente específico
