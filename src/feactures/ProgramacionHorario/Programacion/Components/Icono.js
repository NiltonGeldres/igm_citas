...
// Usaremos los iconos originales de lucide-react, convertidos a componentes locales.
...
export const Icono = ({ nombre, ...props }) => {
    const LucideIcon = { CalendarCheck, ChevronLeft, ChevronRight, X, PlusCircle, Clock, CheckCircle }[nombre];
...
const Icono = ({ nombre, ...props }) => {
    const LucideIcon = { CalendarCheck, ChevronLeft, ChevronRight, X, PlusCircle, Clock, CheckCircle, Save, Loader }[nombre];
    if (!LucideIcon) return null;
    return <LucideIcon {...props} />;
};
