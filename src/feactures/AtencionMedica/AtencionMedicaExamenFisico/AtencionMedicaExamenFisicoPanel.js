...
// src/components/AtencionMedica/ExamenFisicoPanel.js
...
/**
 * Componente específico para el Panel de Examen Físico con dictado por voz.
...
const AtencionMedicaExamenFisicoPanel = ({ content, onContentChange, onModalMessage }) => {
  const title = "Panel Examen Físico"; // Título hardcodeado para este componente específico
