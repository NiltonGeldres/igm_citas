...
function AtencionMedicaForm() {
  ...
  // Sub-pestañas internas para separar limpiamente la firma de la previsualización de recetas/órdenes
...
const ejecutarGuardadoYFirmaFinal = async () => {
  ...
  const menuItems = [
    ...
    { id: 'signature', label: 'Firma y Cierre', icon: PenTool },
  ];
